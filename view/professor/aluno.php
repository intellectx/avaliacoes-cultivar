<?php
	...
	$aluno = Aluno::getAlunoById($_GET['a']);
...
<body class='body-azul'>
	...
	<div class='container-fluid'>
		<div class='container container-aluno' style='max-width:550px;'>
			...
			<button type="button" class="btn btn-danger btn-md" data-toggle="modal" data-target="#cadastroAvaliacao"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Avaliar</button>
			aluno '.$aluno->nome.'
			'); ?>
			<div style="text-align:left" class="modal fade" id="cadastroAvaliacao" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						<form class="form-horizontal" method="POST" action="<?php echo HOME_URI.'/_forms/prof_criaAvaliacao'; ?>">
							<input type="hidden" name="idaluno" value="<?php echo $aluno->id_usuario; ?>">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title" id="myModalLabel">Avaliar <?php echo $aluno->nome; ?></h4>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
											<div class="input-group" style="">
												<input type="text" class="form-control" placeholder="" required name="massa">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
											<div class="input-group">
												<input type="text" class="form-control" placeholder="" name="altura" required>
												<div class="input-group-addon">cm</div>
										</div>
									</div>
								</div>
								<br /><h4 style="font-weight:bolder;">Segundo Ciclo: </h4>
								<div class="form-group">
